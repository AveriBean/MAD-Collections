...
function UserForm() {
  ...
  return (
    <div className="container my-3 col-6 border rounded border-dark">
      {user ? (
      ...
      {user ? (
          ...
          <div className="mb-3">
            ...
            {user ? (
              <Link
                ...
                className="btn yellow-pop m-0"
              >
                Cancel
              </Link>
            ) : (
              <Link to="/login" className="btn yellow-pop m-0">
                Cancel
              </Link>
            )}
          </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            <button type="submit" class="btn dark-pop m-0 me-1">
              Save
            </button>
            <Link to="/login" className="btn yellow-pop m-0">
              Cancel
