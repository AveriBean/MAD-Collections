...
function Profile() {
    ...
    <main style={{minHeight: "75vh"}}>
         ...
         <Card style={{ width: "38rem", marginTop: "15vh", background: "rgb(150, 186, 156)"}}>
             <Card.Body style={{ textAlign: "center", margin: "25px"}}>
                {user.userId == currentUser.userId ? (
                 ...
                 {user.userId == currentUser.userId ? (
                    <>
                        <Card.Text>Full Name: {currentUser.firstName} {currentUser.lastName}</Card.Text>
                    </>
                    ) : ("")}
                 ...
                 <Card.Text>
                 {user.userId == currentUser.userId ? (
                     <Link to={`/editUser/${currentUser.userId}`} className="btn btn-success">
                     Update User Info
                     </Link>
                    ) : ("")}
                 </Card.Text>
